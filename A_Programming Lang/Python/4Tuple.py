...
Tup3 = tuple(("Using constructor",))   # Tuple using constructor / 0for single value use , at end
...
# Change value :- Tuple immutable so first change in list than convert 
...
# Unpacking :- Assign value to tuple called packing but extract values back into variable called unpacking
print("\nUnpacking used :")
